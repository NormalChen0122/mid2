...
int acc_cap_fun(void);
void qcall_acc_cap_fun(Arguments *in, Reply *out);
RPCFunction rpc_qcall_acc_cap_fun(&qcall_acc_cap_fun, "qcall_acc_cap_fun");
